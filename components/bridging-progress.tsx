...
const FACTS = [
  ...
  "Transactions on XRPL EVM finalize in about 5 seconds.",
  "The native currency for XRPL EVM transactions is XRP.",
  "Cross-chain communication is facilitated by the General Message Passing (GMP) protocol and Cosmos IBC.",
  ...
  "Gas fees on XRPL EVM transactions are settled in XRP.",
  ...
  "Users can sign in to dapps with Google and Apple with reown's AppKit.",
  ...
  "MetaMask users can add XRPL EVM by inputting specific RPC URLs and chain ids.",
  "Developers can access a variety of APIs for fetching blockchain data easily.",
  "Developers can utilize Band Protocol Oracles for off-chain data integration.",
  "Developers can utilize Goldsky subgraphs and mirrors for smart contract event indexing.",
  ...
  "XRPL EVM Safe developed by Palmera is a user-friendly platform for managing assets with enhanced security features, supporting multi-signature transactions.",
